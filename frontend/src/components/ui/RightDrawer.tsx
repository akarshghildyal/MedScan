    ...
    return (
        <Dialog.Root open={open} onOpenChange={onOpenChange}>
            <Dialog.Portal>
                ...
                <Dialog.Content
                    className={cn(
                        'fixed inset-y-0 right-0 z-50 flex w-full max-w-[640px] flex-col bg-bg-base shadow-2xl transition-transform duration-200 ease-out focus:outline-none focus:ring-0',
